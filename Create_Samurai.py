        ...
        if traits[0] == "Samurai 侍":
            ...
            if foreground is not None:
                if background == "Summer 夏":
                    ...
                    foreground = foreground.convert('RGBA')
                    base.add_texture_80(foreground, foreground)
            ...
            if wep == "Bow 弓":
                ...
                if clothes == "Armor 鎧":
                    obi = Image.open('images/Ukiyoe Warriors/Apes 猿/Weapons 武器/Demon Sword 妖刀/Obi 帯/w_Armor.png')
                elif clothes == "Street Clothes 街着":
                    obi = Image.open(
                        'images/Ukiyoe Warriors/Apes 猿/Weapons 武器/Demon Sword 妖刀/Obi 帯/w_Street Clothes.png')
                else:
                    obi = Image.open('images/Ukiyoe Warriors/Apes 猿/Weapons 武器/Demon Sword 妖刀/Obi 帯/w_Kimono.png')
            elif wep == "Katana 刀":
                ...
                weapon = Image.open(
                    'images/Ukiyoe Warriors/Apes 猿/Weapons 武器/Niten-Ichiryu 二天一流/{}.png'.format(clan))
                obi = None
            elif wep == "Boar Blades 猪の剣":
