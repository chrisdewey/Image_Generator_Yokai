    ...
    for traits in traits_list:
        if traits[0] == "Samurai 侍":
            ...
            if wep == "Bow 弓":
                ...
                if clothes == "Armor 鎧":
                    obi = Image.open('images/Ukiyoe Warriors/Samurai 侍/Weapons 武器/Demon Sword 妖刀/Obi 帯/w_ Armor.png')
                elif clothes == "Street Clothes 街着":
                    obi = Image.open('images/Ukiyoe Warriors/Samurai 侍/Weapons 武器/Demon Sword 妖刀/Obi 帯/w_ Street Clothes.png')
                else:
                    obi = Image.open('images/Ukiyoe Warriors/Samurai 侍/Weapons 武器/Demon Sword 妖刀/Obi 帯/w_ Kimono.png')
            elif wep == "Katana 刀":
                weapon = Image.open('images/Ukiyoe Warriors/Samurai 侍/Weapons 武器/Katana 刀/{}.png'.format(clan))
                if clothes == "Armor 鎧":
                    obi = Image.open('images/Ukiyoe Warriors/Samurai 侍/Weapons 武器/Katana 刀/Obi 帯/w_ Armor.png')
                elif clothes == "Street Clothes 街着":
                    obi = Image.open('images/Ukiyoe Warriors/Samurai 侍/Weapons 武器/Katana 刀/Obi 帯/w_ Street Clothes.png')
                else:
                    obi = Image.open('images/Ukiyoe Warriors/Samurai 侍/Weapons 武器/Katana 刀/Obi 帯/w_ Kimono.png')
            elif wep == "Niten-Ichiryū 二天一流":
                weapon = Image.open('images/Ukiyoe Warriors/Samurai 侍/Weapons 武器/Niten-Ichiryū 二天一流/{}.png'.format(clan))
                obi = None
            elif wep == "Boar Blades 猪の剣":
                weapon = Image.open('images/Ukiyoe Warriors/Samurai 侍/Weapons 武器/Boar Blades 猪の剣.png')
                obi = None
            elif wep == "SHAman Bow シャマ弓":
            ...
            if foreground is not None:
                if background == "Summer 夏":
                    ...
                    foreground = foreground.convert('RGBA')
                    base = add_texture_80(base, foreground)
                else:
                    foreground = foreground.convert('RGBA')
            ...
            if clothes_type == "Armor 鎧":
                ...
                clothes = Image.open(
                    'images/Ukiyoe Warriors/Musha 武者/Attire 服装/Kimono 着物/Flowers 花/{}.png'.format(clan))
                gauntlets = None
            elif clothes_type == "Kimono Waves 着物波":
            ...
            if wep == "Bow 弓":
                ...
                if clothes == "Armor 鎧":
                    obi = Image.open('images/Ukiyoe Warriors/Musha 武者/Weapons 武器/Demon Sword 妖刀/Obi 帯/w_ Armor.png')
                elif clothes == "Street Clothes 街着":
                    obi = Image.open(
                        'images/Ukiyoe Warriors/Musha 武者/Weapons 武器/Demon Sword 妖刀/Obi 帯/w_ Street Clothes.png')
                else:
                    obi = Image.open('images/Ukiyoe Warriors/Musha 武者/Weapons 武器/Demon Sword 妖刀/Obi 帯/w_ Kimono.png')
            elif wep == "Katana 刀":
                weapon = Image.open('images/Ukiyoe Warriors/Musha 武者/Weapons 武器/Katana 刀/{}.png'.format(clan))
                if clothes == "Armor 鎧":
                    obi = Image.open('images/Ukiyoe Warriors/Musha 武者/Weapons 武器/Katana 刀/Obi 帯/w_ Armor.png')
                elif clothes == "Street Clothes 街着":
                    obi = Image.open('images/Ukiyoe Warriors/Musha 武者/Weapons 武器/Katana 刀/Obi 帯/w_ Street Clothes.png')
                else:
                    obi = Image.open('images/Ukiyoe Warriors/Musha 武者/Weapons 武器/Katana 刀/Obi 帯/w_ Kimono.png')
            elif wep == "Niten-Ichiryū 二天一流":
                weapon = Image.open(
                    'images/Ukiyoe Warriors/Musha 武者/Weapons 武器/Niten-Ichiryū 二天一流/{}.png'.format(clan))
                obi = None
            elif wep == "Boar Blades 猪の剣":
            ...
            if earring_l_trait != "None":
                earring_l = Image.open(
                    'images/Ukiyoe Warriors/Musha 武者/Earrings 耳飾り/Earrings 1 (Left)/{}.png'.format(earring_l_trait))
            else:
                earring_l = None
            if traits[7] != "None":
                earring_r = Image.open(
                    'images/Ukiyoe Warriors/Musha 武者/Earrings 耳飾り/Earrings 2 (Right)/{}.png'.format(traits[7]))
            else:
                earring_r = None
            ...
            head_trait = traits[10]
            if head_trait in ["Ponytail 下げ髪", "Sedge Hat 菅笠", "Bun 髷"]:  # No back No clan
                head = Image.open('images/Ukiyoe Warriors/Musha 武者/Head 頭/{}.png'.format(head_trait))
                head_back = None
            elif head_trait in ["Loose 垂髪 + Headband 鉢巻", "Kabuto 兜"]:  # Back and Clan
            ...
            elif head_trait in ["Ponytail 下げ髪 + Headband 鉢巻", "Bun 髷 + Headband 鉢巻", "Jingasa 陣笠"]:  # NO Back and Clan
                head = Image.open('images/Ukiyoe Warriors/Musha 武者/Head 頭/{0}/{1}.png'.format(head_trait, clan))
                head_back = None
            else:  # Back and NO Clan  LOOSE ONLY
            ...
            skin = Image.open('images/Ukiyoe Warriors/Apes 猿/Skin Base.png')
            # skin_and_head = Image.open('images/Ukiyoe Warriors/Ape 猿/Head Base.png')

            clothes_type = traits[4]

            if clothes_type == "Armor 鎧":
                clothes = Image.open('images/Ukiyoe Warriors/Apes 猿/Attire 服装/Armor 鎧/{}.png'.format(clan))
                gauntlets = Image.open(
                    'images/Ukiyoe Warriors/Apes 猿/Attire 服装/Armor 鎧/Gauntlets 籠手/{0}/{1}.png'.format(traits[5],
                                                                                                          clan))
            elif clothes_type == "Street Clothes 街着":
                clothes = Image.open(
                    'images/Ukiyoe Warriors/Apes 猿/Attire 服装/Street Clothes 街着/{}.png'.format(clan))
                gauntlets = None
            elif clothes_type == "Kimono Flowers 着物花":
                clothes = Image.open(
                    'images/Ukiyoe Warriors/Apes 猿/Attire 服装/Kimono 着物/Flowers 花/{}.png'.format(clan))
                gauntlets = None
            elif clothes_type == "Kimono Waves 着物波":
                clothes = Image.open('images/Ukiyoe Warriors/Apes 猿/Attire 服装/Kimono 着物/Waves 波/{}.png'.format(clan))
                gauntlets = None
            else:
                clothes = Image.open(
                    'images/Ukiyoe Warriors/Apes 猿/Attire 服装/Kimono 着物/Clouds 雲/{}.png'.format(clan))
                gauntlets = None

            wep = traits[5]
            if wep == "Bow 弓":
                weapon = Image.open('images/Ukiyoe Warriors/Apes 猿/Weapons 武器/Bow 弓/{}.png'.format(clan))
                obi = None
            elif wep == "Demon Sword 妖刀":
                weapon = Image.open('images/Ukiyoe Warriors/Apes 猿/Weapons 武器/Demon Sword 妖刀/Demon Sword 妖刀.png')
                if clothes == "Armor 鎧":
                    obi = Image.open('images/Ukiyoe Warriors/Apes 猿/Weapons 武器/Demon Sword 妖刀/Obi 帯/w_ Armor.png')
                elif clothes == "Street Clothes 街着":
                    obi = Image.open(
                        'images/Ukiyoe Warriors/Apes 猿/Weapons 武器/Demon Sword 妖刀/Obi 帯/w_ Street Clothes.png')
                else:
                    obi = Image.open('images/Ukiyoe Warriors/Apes 猿/Weapons 武器/Demon Sword 妖刀/Obi 帯/w_ Kimono.png')
            elif wep == "Katana 刀":
                weapon = Image.open('images/Ukiyoe Warriors/Apes 猿/Weapons 武器/Katana 刀/{}.png'.format(clan))
                if clothes == "Armor 鎧":
                    obi = Image.open('images/Ukiyoe Warriors/Apes 猿/Weapons 武器/Katana 刀/Obi 帯/w_ Armor.png')
                elif clothes == "Street Clothes 街着":
                    obi = Image.open('images/Ukiyoe Warriors/Apes 猿/Weapons 武器/Katana 刀/Obi 帯/w_ Street Clothes.png')
                else:
                    obi = Image.open('images/Ukiyoe Warriors/Apes 猿/Weapons 武器/Katana 刀/Obi 帯/w_ Kimono.png')
            elif wep == "Niten-Ichiryū 二天一流":
                weapon = Image.open(
                    'images/Ukiyoe Warriors/Apes 猿/Weapons 武器/Niten-Ichiryū 二天一流/{}.png'.format(clan))
                obi = None
            elif wep == "Boar Blades 猪の剣":
                weapon = Image.open('images/Ukiyoe Warriors/Apes 猿/Weapons 武器/Boar Blades 猪の剣.png')
                obi = None
            elif wep == "SHAman Bow シャマ弓":
                weapon = Image.open('images/Ukiyoe Warriors/Apes 猿/Weapons 武器/SHAman Bow シャマ弓.png')
                obi = None
            else:
                weapon = None
                obi = None
            ...
            if earring_l_trait != "None":
                earring_l = Image.open(
                    'images/Ukiyoe Warriors/Apes 猿/Earrings 耳飾り/Earrings 1 (Left)/{}.png'.format(earring_l_trait))
            else:
                earring_l = None
            earring_r = None
            ...
            if eyes_trait == "Saiké サイケ":
                print("saike")
                eyes = Image.open('images/Ukiyoe Warriors/Apes 猿/Eyes 目/Saiké サイケ/Eyes.png')
            else:
                eyes = Image.open('images/Ukiyoe Warriors/Apes 猿/Eyes 目/{}.png'.format(eyes_trait))

            face_trait = traits[9]
            if face_trait == "None" or face_trait == "Plain 普通":
                face = None
            else:
                face = Image.open('images/Ukiyoe Warriors/Apes 猿/Face 顔/{}.png'.format(face_trait))
            ...
            if head_trait == "Short 短毛":
                head = None
                skin_and_head = Image.open('images/Ukiyoe Warriors/Apes 猿/Head 頭/Head Base/Short 短毛.png')
                kabuto = None
            elif head_trait == "Short 短毛 + Headband 鉢巻":
                head = Image.open('images/Ukiyoe Warriors/Apes 猿/Head 頭/Headband 鉢巻/{}.png'.format(clan))
                skin_and_head = Image.open('images/Ukiyoe Warriors/Apes 猿/Head 頭/Head Base/{}.png'.format(head_trait))
                kabuto = None
                ...
                head = Image.open('images/Ukiyoe Warriors/Apes 猿/Head 頭/Sedge Hat.png')
                skin_and_head = Image.open('images/Ukiyoe Warriors/Apes 猿/Head 頭/Head Base/Short 短毛.png')
                kabuto = None
            elif head_trait == "Jingasa 陣笠":
                head = Image.open('images/Ukiyoe Warriors/Apes 猿/Head 頭/Jingasa 陣笠/{}.png'.format(clan))
                skin_and_head = Image.open('images/Ukiyoe Warriors/Apes 猿/Head 頭/Head Base/Short 短毛.png')
                kabuto = None
            elif head_trait == "Kabuto 兜":
                head = Image.open('images/Ukiyoe Warriors/Apes 猿/Head 頭/Kabuto 兜/Front/{}.png'.format(clan))
                skin_and_head = Image.open('images/Ukiyoe Warriors/Apes 猿/Head 頭/Head Base/Short 短毛.png')
                kabuto = Image.open('images/Ukiyoe Warriors/Apes 猿/Head 頭/Kabuto 兜/Back.png')
            else:
                head = None
                skin_and_head = None
                kabuto = None
            ...
            if eyes_trait == "Saiké サイケ":
                saike_1 = Image.open('images/Ukiyoe Warriors/Apes 猿/Eyes 目/Saiké サイケ/Glow 1 (add).png')
                saike_2 = Image.open('images/Ukiyoe Warriors/Apes 猿/Eyes 目/Saiké サイケ/Glow 2 (add).png')
                base = add_texture(base, saike_1)
                base = add_texture(base, saike_2)
